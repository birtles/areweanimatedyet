...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    if (this.state.loadState == 'loading') {
      return (
        React.createElement("span", {className: "bug-detail loading"}, React.createElement("a", {
          href: this.getBugLink()}, this.props.id), 
          ' ', "Loading bug details…")
      );
    }
    if (this.state.loadState == 'load-failed') {
      return (
        React.createElement("span", {className: "bug-detail load-failed"}, React.createElement("a", {
          href: this.getBugLink()}, this.props.id), 
    ...
    return (
      React.createElement("span", {className: 'bug-detail ' + this.state.status}, React.createElement("a", {
        href: this.getBugLink()}, this.props.id, " ", this.state.summary), 
        ' ', React.createElement("span", {className: "bug-status"}, "(", status, ")"))
    );
  }
});

},{"./BugInfoMixin":159,"react":156}],158:[function(require,module,exports){
var React = require('react'),
    BugInfoMixin = require('./BugInfoMixin');
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    ...
    return (React.createElement("span", {className: 'bug ' + className}, React.createElement("a", {
      href: this.getBugLink(), 
      title: title}, React.createElement("span", null, "(", this.props.id, ")"))));
  }
});

},{"./BugInfoMixin":159,"react":156}],159:[function(require,module,exports){
...
},{"./BugTracker":160,"./vendor/zepto.js":166}],160:[function(require,module,exports){
var $ = require("./vendor/zepto.js");
...
},{"./vendor/zepto.js":166}],161:[function(require,module,exports){
var React = require('react'),
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "interface"}, 
        React.createElement("div", {className: "interface-header"}, 
          React.createElement("h2", {className: "interface-name"}, React.createElement("a", {
            href: specLink}, this.props.name)
          )
        ), 
        React.createElement("ul", {className: "member-list"}, 
          
            this.props.members.map(function(member) {
              return React.createElement("li", {key: member.name}, React.createElement(Member, React.__spread({},  member)));
            })
...
},{"./Member.jsx":163,"react":156}],162:[function(require,module,exports){
var React = require('react'),
...
module.exports = React.createClass({displayName: "exports",
  render: function() {
    return (
      React.createElement("div", {className: "interface-container"}, 
        
          this.props.interfaces.map(function(interface) {
            return React.createElement(Interface, React.__spread({key: interface.name},  interface));
          })
...
},{"./Interface.jsx":161,"react":156}],163:[function(require,module,exports){
var React = require('react'),
    ...
    return (
      React.createElement("div", {className: 'member ' + (this.implementation().status || 'none')}, 
        React.createElement("div", {className: "member-summary"}, 
          ...
          React.createElement("a", {href: specLink, className: "spec-link", 
            target: "_new", 
...
},{"./BugIcon.jsx":158,"./MemberDetail.jsx":164,"react":156}],164:[function(require,module,exports){
var React = require('react'),
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    return (
      React.createElement("div", {id: this.props.id, className: "details", 
        role: "region", tabIndex: "-1", "aria-expanded": this.state.open, 
        ref: "panel"}, 
         this.props.note
          ? React.createElement("div", {className: "notes"}, "Notes: ", this.props.note)
          : null, 
         this.props.bugs
          ? React.createElement("ul", {className: "bug-list"}, 
            
              this.props.bugs.map(function(bugNum) {
                return React.createElement("li", {key: 'bug-detail-' + bugNum}, 
                         React.createElement(BugDetail, {id: bugNum})
                       );
              }.bind(this))
...
},{"./BugDetail.jsx":157,"react":156}],165:[function(require,module,exports){
var $ = require('./vendor/zepto.js'),
    React = require('react'),
    BugTracker = require('./BugTracker'),
...
$.getJSON('status.json').then(function(interfaces) {
  ...
  React.render(
    React.createElement(InterfaceContainer, {interfaces: interfaces}),
...
},{"./BugTracker":160,"./InterfaceContainer.jsx":162,"./vendor/zepto.js":166,"react":156}],166:[function(require,module,exports){
(function (global){
